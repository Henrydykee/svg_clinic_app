  ...
  Widget build(BuildContext context) {
    return Padding(
      ...
      child: TextFormField(
        ...
        style: TextStyle(fontSize: 56,fontFamily: "Sora",fontWeight: FontWeight.w700,color: Colors.white,),
        decoration: InputDecoration(
            prefix: widget.prefix,
            // prefixText: Strings.dollar_sign,
            counterText: "",
            suffixStyle: TextStyle(fontSize: 56,fontFamily: "Sora",fontWeight: FontWeight.w700),
            suffixText: widget.suffixText,
            prefixStyle: TextStyle(color: Colors.black),
            labelText: widget.labelText,
            hintText: widget.hintText ?? '0.00',
            hintStyle: TextStyle(fontSize: 64,fontFamily: "Sora",fontWeight: FontWeight.w700,color: Colors.white),
